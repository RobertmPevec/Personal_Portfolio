export const info = {
  ...
  about: `I’m a Software Engineer based in Toronto, Ontario,
   with a passion for creating new things and solving complex problems. 
   My skills include Python, C++, Javascript, and SQL. With a strong foundation in mathematics
  ...
  projects: [
    ...
    },
    {
      ...
      isFeatured: false,
      thumbnail: "/assets/images/recipewizardhome.png",
    ...
    {
      title: "Clip Genius: ML Sports Highlight Generator",
      isFeatured: true,
      thumbnail: "/assets/images/frontendhome.png",
      githubUrl: "https://github.com/RobertmPevec/Clip_Genius",
      liveUrl: "/clipgenius",
    },
    {
      title: "Grocery Hawk: Grocery Price Comparison Website",
      isFeatured: true,
